...
class ParagraphNode(BaseModel):
    ...
    name: str
    url: str
    children: list[ParagraphNode] = Field(default_factory=list)
    ...
    def iterate_dfs(self) -> Iterator[ParagraphNode]:
        """Итерация в глубину (Depth-First Search)"""
        yield self
        for child in self.children:
            yield from child.iterate_dfs()

    def iterate_bfs(self) -> Iterator[ParagraphNode]:
    ...
    def iterate_leaves(self) -> Iterator[ParagraphNode]:
